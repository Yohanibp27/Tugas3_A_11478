...
st.markdown("""
        <div class="center">
            <img src="https://media.tenor.com/oqo9GcbfjYAAAAi/welcome-images-server.gif" alt="Welcome Image">
        </div>
            """, unsafe_allow_html=True)


st.markdown("<h1 style='text-align: center; color: #4CAF50;'> Prediksi IPK - 1478 </h1>", unsafe_allow_html=True)
...
uploded_file = st.sidebar.file_uploader("Upload file dataset_regresi_IPK.csv", type=['csv'])

if uploded_file is not None:
    input_data = pd.read_csv(uploded_file)
    st.write("<h3 style-'text-align: center; color: #0073e6;'> Data yang diupload : </h3>", unsafe_allow_html=True)
    st.dataframe(input_data)

    model_path = os.path.join(r'SVR_IPK_model.pkl')
